# Distribution and SDK Notice

`dsh-fylar-office-editor` is distributed as a GitHub-hosted DeepSeek Harness
...
Third-party runtime notices are preserved in
`vendor/office-sdk/THIRD_PARTY_NOTICES` and inside the unmodified SDK `lib/`
directory. Do not remove or replace these notices, and do not label the bundled
SDK or the combined package as MIT, Apache-2.0, or another open-source license.
