...
describe('Office styles', () => {
  it('composes the workspace, artifact, and editor sections', () => {
    expect(OFFICE_STYLES).toContain('.fylar-office-view')
    expect(OFFICE_STYLES).toContain('.fylar-office-artifact-card')
    expect(OFFICE_STYLES).toContain('.fylar-office-editor-inline')
    expect(OFFICE_STYLES).toContain('.fylar-office-action-menu')
    expect(OFFICE_STYLES).toContain('.fylar-office-mode-badge')
    ...
    expect(OFFICE_STYLES).toContain('.fylar-office-details:fullscreen')
    ...
    expect(OFFICE_STYLES).not.toContain('.fylar-office-dialog')
  })
